...
export const SchemaOne = yup.object().shape({
    title:yup.string().min(3,"title is too less").max(35,"title is too long").required("this field is required"),
    type:yup.string().max(35,"type is too long").required("this field is required"),
